...
//                    if (selectedItem.itemEquip) // 장착하지 않았을 때
//                    {
//                        player.E(selectedItem); // 장착 해제에 해당 아이템 입력
...
//                        for (int i = 0; i < player.InvenItem.Count; i++) // 아이템 불러오기
//                        {
//                            if (player.InvenItem[i].itemEquip == false) // 인벤 아이템이 장착이 안 되어있을 경우
//                            {
//                                continue; // 다음 문장으로 넘어가라
//                            }
//                            if (player.InvenItem[i].itemType == selectedItem.itemType) // 현재 장착중인 아이템
//                            {
//                                player.UnE(player.InvenItem[i]); // 장착 해제
